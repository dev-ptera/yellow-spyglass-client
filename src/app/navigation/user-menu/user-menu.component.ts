...
@Component({
    ...
    template: `
        <ng-container *transloco="let t; scope: 'navigation'; read: 'navigation'">
            <blui-user-menu class="app-user-menu" [menuTitle]="t('settings')" [(open)]="userMenuOpen">
