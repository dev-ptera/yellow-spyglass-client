    ...
    template: `
        <div class="nfts-tab-container">
            ...
            <mat-card *ngIf="!nfts || nfts.length === 0" class="divider-border" style="padding: 0">
                <div class="mat-headline" *ngIf="isLoadingNFTs" style="padding: 32px">Loading...</div>

                <blui-empty-state
                    *ngIf="!isLoadingNFTs && nfts.length === 0"
                    responsive
                ...
                >
                    ...
                    <div blui-description>
                        This account currently owns no NFTs. Learn more about Banano NFTs
                        <a
                            class="primary"
                            href="https://www.reddit.com/r/banano/comments/v8ttyh/banano_nft_metaprotocol_specification_v100_release/"
                            target="_blank"
                            >here</a
                        >.
                    </div>
            ...
            <div *ngIf="!isLoadingNFTs" class="nft-body-container" responsive>
                <ng-container *ngIf="nfts.length !== 0">
                    <mat-card *ngFor="let nft of nfts" class="divider-border">
                        ...
                        <div
                            [style.height.px]="nft.isExpanded ? 170 : 0"
